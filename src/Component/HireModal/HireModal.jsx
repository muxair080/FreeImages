...
import useStyles from "../MsgModal/Style";
        ...
        <Box sx={style}>
          <div className={classes.profile_name}>
            <img
              ...
              src={ImageItem.user.profile_image.large}
              alt="Profile"
            />
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            Send Message to {ImageItem.user.name} and recive reply through your
            email.
          </Typography>
